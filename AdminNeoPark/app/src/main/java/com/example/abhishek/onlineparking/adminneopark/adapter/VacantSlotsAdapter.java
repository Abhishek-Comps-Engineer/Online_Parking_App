...
public  class VacantSlotsAdapter extends RecyclerView.Adapter<VacantSlotsAdapter.VacantSlotViewHolder> {
    ...
    @NonNull
    @Override
    public VacantSlotsAdapter.VacantSlotViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_slot, parent, false);
        return new VacantSlotViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VacantSlotViewHolder holder, int position) {
...
//        holder.editButton.setVisibility(GONE);
    ...
    static class VacantSlotViewHolder extends RecyclerView.ViewHolder {
        TextView name, vehicleType, time, price , noSlots;
        Button editButton, deleteButton, statusText;

        public VacantSlotViewHolder(@NonNull View itemView) {
            super(itemView);
