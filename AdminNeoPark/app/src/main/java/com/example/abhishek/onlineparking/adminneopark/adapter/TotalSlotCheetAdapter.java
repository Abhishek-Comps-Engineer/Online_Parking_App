...
public  class TotalSlotCheetAdapter extends RecyclerView.Adapter<TotalSlotCheetAdapter.TotalSlotViewHolder> {
    ...
    @NonNull
    @Override
    public TotalSlotCheetAdapter.TotalSlotViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_slot, parent, false);
        return new TotalSlotViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TotalSlotViewHolder holder, int position) {
...
//        holder.editButton.setVisibility(GONE);
    ...
    static class TotalSlotViewHolder extends RecyclerView.ViewHolder {
        TextView name, vehicleType, time, price , noSlots;
        Button editButton, deleteButton, statusText;

        public TotalSlotViewHolder(@NonNull View itemView) {
            super(itemView);
