 ...
 * Use the {@link UpcomingReservedLotFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UpcomingReservedLotFragment extends Fragment {


    String TAG = "UpcomingReservedLotFragment";
    ...
    public UpcomingReservedLotFragment() {
     ...
     * @return A new instance of fragment UpcomingReservedLotFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static UpcomingReservedLotFragment newInstance(String param1, String param2) {
        UpcomingReservedLotFragment fragment = new UpcomingReservedLotFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_upcoming_reserved_lot, container, false);


        recyclerViewActive = v.findViewById(R.id.upcomingSlotList);
        ...
        reservedViewModel.getUsedSlotsLiveData().observe(getViewLifecycleOwner(), new Observer<List<SlotModel>>() {
            ...
            public void onChanged(List<SlotModel> slotModels) {
                ...
                slotAdapter.setSlotUpcomingList(bookedSlots);
